# Ground Truth Rules - Table 22 Row 18
...
```text
Intracoronary pressure measurement (FFR or iFR) or computation (QFR) should be considered at the end of the procedure to identify patients at high risk of persistent angina and subsequent clinical events
```
...
graph LR
  ...
  subgraph Table22Row18_and_1_AND
