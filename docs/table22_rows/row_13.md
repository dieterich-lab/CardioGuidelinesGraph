...
graph LR
  subgraph Expected_and_1_AND
    ...
    D1 -->|LEADS_TO| D2
    D2 -->|RESULTS_IN| REC
    ACT1[Procedure: post-procedural outcomes]
    REC -->|RECOMMENDS_* / CONTRAINDICATES| ACT1
    ACT2[Procedure: procedural risks]
...
graph LR
  subgraph Actual_and_1_AND
    ...
    C4[Condition: multivessel coronary artery disease]
    ...
    C6[Condition: surgically eligible chronic coronary syndrome patients]
